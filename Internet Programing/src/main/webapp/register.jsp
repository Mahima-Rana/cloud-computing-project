      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
			...
			<%-- registerServlet IS FOR ADD A NEW USER --%>
              <form action=registerServlet method=post onsubmit="return checkPasswords()">
                ...
                <div class="form-outline mb-4">
                  <input type="text" pattern="[789][0-9]{9}" autocomplete="off" placeholder="Mobile Number" id="userMobile" class="form-control form-control-Default" name="userMobile" required>
                </div>
